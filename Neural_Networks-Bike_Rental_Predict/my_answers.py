...
class NeuralNetwork(object):
    ...
    def forward_pass_train(self, X):
        ...
        #since the layer just passes on its value, so we do not have to apply the sigmoid here
    ...
    def backpropagation(self, final_outputs, hidden_outputs, X, y, delta_weights_i_h, delta_weights_h_o):
        ...
        # TODO: Backpropagated error terms - Replace these values with your calculations. (I HAD TO CHANGE THE ORDER)
        #output_error_term = error * final_outputs * (1 - final_outputs)
        # Derivative of the activation function y=x is equal to 1
    ...
    def run(self, features):
        ...
        final_inputs = np.dot(hidden_outputs, self.weights_hidden_to_output) # signals into final output layer
        #final_outputs = self.activation_function(final_inputs) # signals from final output layer 
        # since the last layer just passes on its value, so we do not have to apply the sigmoid here
        final_outputs = final_inputs
...
##########################################################
iterations = 9000#1500#3000#9000
learning_rate = 0.5#1.1#0.5#0.22
hidden_nodes = 15#15#12
output_nodes = 1
